...
$events: any;
  ...
  senddata() {
    ...
    if (this.email == "" || this.password == "") {
    ...
    } else if (EmailValidator.validate(this.email) != true) {
      this.messageSuccess = true;
      this.showMessageSuccess();
      this.error = "Error";
      this.errorInfo = "Please enter a valid email adress";
    }else {
      this.api.getByEmail(datax).subscribe(
        ...
        (error) => {
          if (error == 'Not found' || error.statut == 300) {
            this.messageSuccess = true;
            this.showMessageSuccess();
            this.error = "Error";
            this.errorInfo = "Username Or Password not working";
  ...
  this.api._forgetPassowrd(data).subscribe((data)=>{ this.messageSuccess = true;
    this.showMessageSuccess();
    this.error = "Succes";
    this.errorInfo = data;
    this.forget = false
