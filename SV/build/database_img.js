...
const keys_database_img_1 = __importDefault(require("./keys.database_img"));
const db_img_user = mysql_1.default.createPool(keys_database_img_1.default.database);
db_img_user.getConnection((err, con) => {
    if (err) {
        console.log({
            status: "failed",
        ...
        if (con) {
            ...
            console.log('\x1b[32m%s\x1b[0m', {
                status: "success",
                message: "MySQL connected. [Photo]   "
            });
        }
    }
});
exports.default = db_img_user;
