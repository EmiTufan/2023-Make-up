...
const db_login_admin = mysql_1.default.createPool(keys_database_1.default.database_Login_Admin);
db_login_admin.getConnection((err, con) => {
    if (err) {
        console.log({
            status: "failed",
...
exports.default = db_login_admin;
